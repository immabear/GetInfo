...
<div id='bodydiv'>
 <table id='maintaskbar' cellspacing='0'>
  <tr id='taskbar'>
   <td id='hometasktd' class='middle'><button id='hometask' class='buttonmed' onclick='tab(this.parentNode);show(\"home\",\"homebox\")'>Home</button></td>
 ...
 <div id='home'>
  <table id='hometaskbar' cellspacing='0'>
   <tr id='movietask'>
    <td id='theatertasktd' class='middle'><button id='theatertask' class='buttonbig' onclick='tab(this.parentNode);fetchPage(\"homebox\",sources[0]);'>In Theaters</button></td>
